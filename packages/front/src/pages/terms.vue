  ...
  <inner-page title="Terms and Conditions">
    <div class="content-page">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to OpenForTravel, accessible from
            <a href="http://openfortravel.org" rel="external nofollow noopener" target="_blank"
              >http://openfortravel.org</a
            >
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        an obligation under this Terms shall not effect a party's ability to exercise such
      ...
      <ul>
        <li>
          <p>By email: contact@openfortravel.org</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:
            <a href="https://openfotravel.org/contact">https://openfotravel.org/contact</a>
          </p>
        </li>
      </ul>
    </div>
